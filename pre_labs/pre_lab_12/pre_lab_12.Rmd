...
**Answer: Some of the sentiments can be incorrect depending on the context. For example, the word patient could be negative instead of positive if a patient is very sick.**
...
bing_word_counts_2023 |> group_by(sentiment) |> summarize(sum(n))
```
