...
**Answer: md_county_notices gives foreclosure notices for each county and md_county_populations gives population for each county.**
...
**Answer: This creates a dataset for the population of each county in Maryland with a geometry column.**
...
**Answer: This code shows both datasets.**
...
**Answer: The population datatset had columns renamed and only the county, population and geometry columns are shown.**
...
**Answer: The foreclosure and population datasets were combined in a join.**
...
**Answer: A rate of notices per 1,000 people was added to the dataset.**
...
**Answer: A map was created to show the rate of ntocies per 1,000 people for each county. The rare can be determined by the color of each county.**
...
**Answer: This also creates a map that shows the rate, but the colors to determine the rate are a lot more different.**
...
**Answer: The northern part of Maryland has the lowest rate of notices in the state.**
