...
What is the average household income for high schools that have less than 200 students?

```{r}
md_high_schools_with_acs |>
  filter(high_school_graduates < 200) |>
  summarise(avg_income = mean(estimate), count =n())
```
